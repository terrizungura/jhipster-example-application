...
class CategoryResourceIT {
    ...
    private static final String DEFAULT_WELCOME = "AAAAAAAAAA";
    private static final String UPDATED_WELCOME = "BBBBBBBBBB";
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getWelcome()).isEqualTo(DEFAULT_WELCOME);
    ...
    @Test
    @Transactional
    void checkWelcomeIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setWelcome(null);
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].welcome").value(hasItem(DEFAULT_WELCOME)))
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.welcome").value(DEFAULT_WELCOME))
    ...
    void putNewCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getWelcome()).isEqualTo(UPDATED_WELCOME);
