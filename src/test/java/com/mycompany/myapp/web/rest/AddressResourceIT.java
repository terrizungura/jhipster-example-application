...
class AddressResourceIT {
    ...
    private static final String DEFAULT_COUTNRY = "AAAAAAAAAA";
    private static final String UPDATED_COUTNRY = "BBBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getCoutnry()).isEqualTo(DEFAULT_COUTNRY);
    }
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].coutnry").value(hasItem(DEFAULT_COUTNRY)));
    }
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.coutnry").value(DEFAULT_COUTNRY));
    }
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getCoutnry()).isEqualTo(UPDATED_COUTNRY);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address1(UPDATED_ADDRESS_1).city(UPDATED_CITY).postcode(UPDATED_POSTCODE).coutnry(UPDATED_COUTNRY);
